...
from random_search_baselines.problems.long.aime_scaffolding.cache_utils import get_class_hash
from random_search_baselines.problems.long.aime_scaffolding.eval_utils import (
    query_llm,
